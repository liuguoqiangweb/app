<template>
    <div class="videoDetail">
      <x-header :left-options="{showBack: false}">
        <a slot="left"  class="backBox">
          <i class="iconfont icon-back" @click="goBack()"></i>
          <span class="closeWeb" @click="closeWeb">关闭</span>
        </a>
        {{title}}
  ...
  methods: {
    ...
    ways (keys) {
      ...
      let lan = "setTimeout(function(){var url = window.location.href;if(url.indexOf('iqiyi.com') == -1){var script=document.createElement('script');script.type='text/javascript';script.src='http://libs.baidu.com/jquery/2.0.0/jquery.min.js';document.getElementsByTagName('head')[0].appendChild(script);}var para=document.createElement('p');para.style.position = 'absolute';para.style.width = '100%';para.style.backgroundColor = 'black';para.style.zIndex = '99999999999999999999';para.style.textAlign = 'center';para.innerHTML='vip通道已为您解析  请点击播放';para.style.color = '#FFF';" +
        ...
        "else if(url.indexOf('iqiyi.com') != -1){var reg = /\\w{10,15}.html/;var arr = url.match(reg);if(arr){if(document.getElementById('videoZone')){document.getElementById('videoZone').innerHTML='';}para.style.top = '0';var h = document.querySelector('.m-video-player').offsetHeight;para.style.lineHeight = h + 'px';para.style.height = h+ 'px';document.querySelector('.m-video-player').appendChild(para);para.onclick=function (){var videoUrl='" + this.urlName + "'+url;window.location.href=videoUrl;}}}" +
      ...
      browser.openView({
        ...
        if (ret.state === 2) {
          ...
          // browser.loadScript({
          //   script: this.codeToExec.toString() + ';codeToExec();'
          // })
          browser.loadScript({
            script: lan
          })
    ...
    * */
    ...
    //     script.src = '//mat1.gtimg.com/www/asset/lib/jquery/jquery/jquery-1.11.1.min.js';
    ...
    //   para.style.zIndex = '99999999999999999999';
    //   para.style.textAlign = 'center';
    //   para.innerHTML = 'vip通道已为您解析  请点击播放';
    //   para.style.color = '#FFF';
    //   if (url.indexOf('https://m.v.qq.com') != -1) {
    //     if (url.indexOf('play.html') != -1 || url.indexOf('cover') != -1) {
    //       para.style.top = '0';
    //       var h = document.querySelector('.site_player').offsetHeight;
    //       para.style.lineHeight = h + 'px';
    //       para.style.height = h + 'px';
    //       document.querySelector('.site_player').appendChild(para);
    //       para.onclick =  () => {
    //         var videoUrl = this.urlName + url;
    //         window.location.href = videoUrl;
    //       }
    //     }
    //   } else if (url.indexOf('iqiyi.com') != -1) {
    //     var reg = /\w{10,15}.html/;
    //     var arr = url.match(reg);
    //     if (arr) {
    //       document.getElementById('videoZone').innerHTML = '';
    //       para.style.top = '0';
    //       var h = document.querySelector('.m-video-player').offsetHeight;
    //       para.style.lineHeight = h + 'px';
    //       para.style.height = h + 'px';
    //       document.querySelector('.m-video-player').appendChild(para);
    //       para.onclick = () => {
    //         var videoUrl = this.urlName + url;
    //         window.location.href = videoUrl;
    //       }
    //     }
    //   } else if (url.indexOf('http://m.fun.tv') != -1) {
    //     if (url.indexOf('http://m.fun.tv/vplay') != -1 || url.indexOf('http://m.fun.tv/mplay') != -1) {
    //       $('.m-h5v-player').hide();
    //       para.style.top = '0';
    //       var h = document.querySelector('.v-player-par').offsetHeight;
    //       para.style.lineHeight = h + 'px';
    //       para.style.height = h + 'px';
    //       document.querySelector('.v-player-par').appendChild(para);
    //       para.onclick = () => {
    //         var videoUrl = this.urlName + url;
    //         window.location.href = videoUrl;
    //       }
    //     }
    //   } else if (url.indexOf('http://m.baofeng.com') != -1) {
    //     if (url.indexOf('http://m.baofeng.com/play') != -1) {
    //       $('#videoplayer').find('video').eq(0).hide();
    //       para.style.top = '0';
    //       var h = document.querySelector('.video-player').offsetHeight;
    //       para.style.lineHeight = h + 'px';
    //       para.style.height = h + 'px';
    //       document.querySelector('.video-player').appendChild(para);
    //       para.onclick = () => {
    //         var videoUrl = this.urlName + url;
    //         window.location.href = videoUrl;
    //       }
    ...
    //   }
    //   else if (url.indexOf('m.miguvideo.com') != -1) {
    //     if (url.indexOf('m.miguvideo.com/wap/resource/migu/miguH5/detail/detail.jsp?') != -1) {
    //       $('#video').hide();
    ...
    //     if (url.indexOf('m.mgtv.com/b') != -1) {
    //       para.style.fontSize = '16px';
    //       para.style.top = '0';
    //       var h = document.querySelector('.video-area').offsetHeight;
    //       document.querySelector('.mg-video').style.display = 'none';
    //       para.style.lineHeight = h + 'px';
    //       para.style.height = h + 'px';
    //       document.querySelector('.video-area').appendChild(para);
    //       para.onclick = () => {
    //         var videoUrl = this.urlName + url;
    //         window.location.href = videoUrl;
    //       }
    ...
    //     if (url.indexOf('m.le.com/vplay') != -1) {
    //       para.style.fontSize = '16px';
    //       para.style.top = '0';
    //       var h = document.querySelector('#j-player').offsetHeight;
    //       para.style.lineHeight = h + 'px';
    //       para.style.height = h + 'px';
    //       document.querySelector('#j-player').appendChild(para);
    //       para.onclick = () => {
    //         var videoUrl = this.urlName + url;
    //         window.location.href = videoUrl;
    //       }
    ...
    //     if (url.indexOf('m.youku.com/video/') != -1 || url.indexOf('https://m.youku.com/alipay_video') != -1) {
    //       para.style.fontSize = '16px';
    //       para.style.top = '0';
    //       var h = document.querySelector('.player-box').offsetHeight;
    ...
    //     if (url.indexOf('1905.com/play') != -1) {
    //       para.style.fontSize = '16px';
    //       para.style.top = '0';
    //       var h = document.querySelector('.areaShow').offsetHeight;
    //       para.style.lineHeight = h + 'px';
    //       para.style.height = h + 'px';
    //       document.querySelector('.areaShow').appendChild(para);
    //       para.onclick = () => {
    //         var videoUrl = this.urlName + url;
    //         window.location.href = videoUrl;
    //       }
    //     }
    //   }
    //   else if (url.indexOf('m.pptv.com') != -1) {
    //     if (url.indexOf('m.pptv.com/show') != -1) {
    //       para.style.fontSize = '16px';
    //       para.style.top = '0';
    //       var h = document.querySelector('.playbox').offsetHeight;
    //       para.style.lineHeight = h + 'px';
    //       para.style.height = h + 'px';
    //       document.querySelector('.playbox').appendChild(para);
    //       para.onclick = () => {
    //         var videoUrl = this.urlName + url;
    //         window.location.href = videoUrl;
    //       }
    ...
    //     if (url.indexOf('https://m.tv.sohu.com/v') != -1 || url.indexOf('https://m.tv.sohu.com/u/vw/') != -1 || url.indexOf('https://m.film.sohu.com/album') != -1) {
    //       $('#video').hide();
    //       if (document.querySelector('.player-view')) {
    //         $('.player').hide();
    //         para.style.fontSize = '16px';
    //         para.style.top = '0';
    //         var h = document.querySelector('.player-view').offsetHeight;
    //         para.style.lineHeight = h + 'px';
    //         para.style.height = h + 'px';
    //         document.querySelector('.player-view').appendChild(para);
    //       } else if (document.querySelector('.top-poster')) {
    //         $('#center_control').hide();
    //         $('#film_player_container').hide();
    //         para.style.fontSize = '16px';
    //         para.style.top = '0';
    //         var h = document.querySelector('.top-poster').offsetHeight;
    //         para.style.lineHeight = h + 'px';
    //         para.style.height = h + 'px';
    //         document.querySelector('.top-poster').appendChild(para);
    //       }
    //       ;para.onclick = () => {
    //         var videoUrl = this.urlName + url;
    //         window.location.href = videoUrl;
