<template>
  <div id="classify">
    <div class="header" :style="{paddingTop: statusH + 'rem',color: '#333',background: '#fff'}">
      ...
      <div class="list" :class="{over: showMore}"  :style="{top: statusH + 0.88 +'rem'}">
        ...
        <mescroll-vue ref="mescroll"  :down="mescrollDown" :up="mescrollUp" @init="mescrollInit">
          <div class="dialog" v-if="showMore" @click="showMore = false"></div>
            <template v-for="item of design" v-if="design && !cate && isTM">
        ...
        <div class="recommend" :style="{paddingTop: listTop + 'rem'}">
          <goods-item v-bind:list = list v-bind:showVideo=showVideo v-bind:styles="!styles" @detail="detail" @openVideo="openVideo"></goods-item>
        </div>
        </mescroll-vue>
      </div>
...
export default {
  ...
  beforeRouteEnter (to, from, next) {
    next(vm => {
      ...
      vm.isTM = vm.$route.query.type === 'hdk_9'
