  ...
  <div class="home_detail" style="height:100%;">
    ...
    <div v-if="isShowQrcode">
      <div class="mall-sq-body">
        ...
        <img class="shopClose" src="../../../assets/img/sign/close.png" alt="" @click="handleClose()">
      </div>
    </div>
  </div>
</template>
    ...
    shareFri (type) {
      ...
      api.download({
        ...
        wx.shareWebpage({
          ...
          thumb: 'fs://' + format,
          contentUrl: that.detailObj.shareInfo.url1 || that.detailObj.shareInfo.url || link || that.detailObj.shareInfo.link.merge
        }, function (ret, err) {
          if (ret.status) {
