            ...
            <div class="centerBox">
              ...
              <div class="info">
                ...
                <div class="money" :style="{color: $store.state.global.theme.mainColor}">
                  ...
                  <p class="profit" v-if="item.dengji==0 && item.estimated_effect>0">{{item.title1}}:{{item.estimated_effect}} {{item.title2}}:{{item.payment_price2}}</p>
                  <p class="profit" v-if="item.dengji>0 && item.estimated_effect>0">{{item.title3}}:{{item.estimated_effect}}</p>
                </div>
              </div>
            </div>
            <div class="bot">
